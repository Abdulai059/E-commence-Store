function CategoriesCard({ category }) {
  ...
  return (
    <div className="group relative w-full rounded-xl bg-white p-4 shadow-2xs transition-all duration-300 hover:shadow-2xl">
      {/* Image Wrapper */}
      <div className="mx-auto flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border-2 border-transparent hover:border-red-400 sm:h-28 sm:w-28 md:h-20 md:w-20">
        <img
          src={image_url}
          alt={name}
