...
function Feature() {
  ...
  return (
    <section className="pb-20">
      ...
      <div className="mx-5 mb-10 flex max-w-6xl flex-col md:mx-auto md:items-start">
        <h1 className="mb-2 text-center text-3xl font-medium text-slate-800">Our Feature Items</h1>
