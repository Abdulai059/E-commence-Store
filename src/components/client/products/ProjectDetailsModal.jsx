...
function ProjectDetailsModal({ onCloseModal }) {
  const product = {
      ...
      <div className="mt-4 flex flex-col gap-16 md:flex-row">
        <div className="flex gap-3">
          ...
          <div className="max-w-100 overflow-hidden rounded border border-gray-500/30">
            <img src={thumbnail} alt="Selected product" className="h-full w-full object-cover" />
          </div>
        </div>
        ...
        <div className="w-full text-sm md:w-1/2">
          ...
          <div className="mt-1 flex items-center gap-0.5">
            ...
            <p className="ml-2 text-base">({product.rating})</p>
          </div>
