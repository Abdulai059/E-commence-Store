function Footer() {
  return (
    <footer className="w-full bg-white px-4 pt-25 text-sm text-slate-500">
      <div className="grid grid-cols-1 gap-14 sm:grid-cols-2 lg:grid-cols-3">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="mt-6 text-base">
            PrebuiltUI is a free and open-source UI component library with over 300+ beautifully
            crafted, customizable components built with Tailwind CSS.
          </p>
        </div>
        <div className="flex flex-col lg:items-center lg:justify-center">
          <div className="flex flex-col space-y-2.5 text-sm">
            <h6 className="mb-5 font-semibold text-gray-800">Company</h6>
        ...
        <div>
          <h6 className="mb-5 font-semibold text-gray-800">Subscribe to our newsletter</h6>
