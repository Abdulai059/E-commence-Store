...
function Footer() {
  return (
    <footer className="w-full bg-[#424242] px-0 pt-10 text-sm text-slate-100 md:mt-40">
        ...
        <div className="flex flex-col lg:items-center lg:justify-start">
          <div className="flex flex-col space-y-3 text-sm">
            <span>
              ...
              <div class="mb-2 h-[3px] w-32 bg-gradient-to-l from-transparent to-green-600"></div>
            </span>
            ...
            <a className="flex items-center gap-2 transition hover:text-slate-300" href="#">
              Careers
              <span className="rounded-md bg-green-600 px-2 py-0.5 text-xs text-white">
                We're hiring!
              </span>
            </a>
        ...
        <div className="hidden md:flex">
          ...
          <div className="max-w-sm space-y-6 text-sm">
            ...
            <div className="flex items-center gap-2 rounded-md bg-indigo-50 p-2">
              <input
                className="text- base w-full max-w-64 rounded px-2 py-2 text-gray-600 ring-green-600 outline-none focus:ring-2"
                type="email"
      ...
      {/* Bottom copyright */}
      <p className="mx-auto mt-12 border-t border-gray-100/20 bg-[#323232] py-4 text-center text-xs text-slate-50">
        © 2025{" "}
